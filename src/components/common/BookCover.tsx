...
export default function BookCover({ book, size }: { book: Buch, size: 'large' | 'small'}) {

    const coverClass = size === 'large' ? 'border-4 h-80 w-60 rounded-lg' : 'border-2 h-48 w-36 m-2';
